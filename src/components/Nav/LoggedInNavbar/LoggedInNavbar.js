...
import css from "./LoggedInNavbar.module.scss";
    ...
    return (
        <div className={css.navbar}>
            ...
            <div className={css.right}>
                ...
                <Link className={css.hovBox} to="#" target="_blank">
                    Edumanabo Bussiness
                </Link>
                ...
                <div className={css.profile}>
                    <img alt="HTT" src={images.userEmptyIcon} className={css.profileIcon} />
                        ...
                        <div className={css.innerMenuBox}>
                            ...
                            <div className={css.prflDiv}>
                                <div className={css.menuItem2}>
                                    ...
                                    <span onClick={() => setShowLanguageSettingsModal(true)}>
                                        <span>English</span>
                                        <img src={images.globeIcon} className={css.icon} alt="glob icon" />
                                    </span>
                                </div>
                            </div>
                            <hr className={css.hr} />
