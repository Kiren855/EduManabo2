...
function VideoPlayer({ lesson, onToggleExpandedView }) {
    ...
    const isYouTubeVideo = lesson.Contents.Video_url.includes("youtube.com");
            ...
            <div className={cx('video-container')} style={{
                ...
                {isYouTubeVideo ? (
                    <div className={cx('video-wrapper')}>
                        <iframe
                            src={`${lesson.Contents.Video_url}?enablejsapi=1`}
                            title="YouTube video player"
                            frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
                        <button className={cx('custom-button')} onClick={toggleExpandedView}>
                            {isExpandedView ? (
