...
import DraftTextEditorUtil from "~/utils/DraftTextEditorUtil";
import SelectDropdownUtil from "~/utils/SelectDropdownUtil";
import PlanModalUtil from "~/utils/PlanModalUtil";


import css from "./NotesTabComponent.module.scss";
import images from "~/assets/images";

const NotesTabComponent = () => {
    const [showDeleteModal, setShowDeleteModal] = useState(false);
    const [showEditor, setShowEditor] = useState(false);
    const [editorState, setEditorState] = useState("Beauty");
        ...
        <div className={css.outerDiv}>
            {showEditor ? null : (
                ...
                >
                    ...
                    <span>
                        <img src={images.pencilIcon} alt="edit" className={css.editIcon} />
                    </span>
                </button>
            )}
            {showEditor ? (
                ...
                <div className={css.detWithTTl}>
                    ...
                    <div className={css.optionBtns}>
                        <div className={css.optionBtn} onClick={editClickHanlder}>
                            <img alt="edit" src={images.pencilIcon} className={css.optionIcon} />
                        </div>
                        <div className={css.optionBtn} onClick={deleteClickHanlder}>
                            <img alt="edit" src={images.deleteIcon} className={css.optionIcon} />
                        </div>
                    </div>
                </div>
                {editNote ? (
