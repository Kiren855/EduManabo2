...
import css from "./CommentBoxUtil.module.scss";
                ...
                <div className={css.pc2}>
                    <div className={css.p2In}>
                        ...
                        >
                            ...
                            <img
                                ...
                                src={state.upvote ? images.upArrowCircleBoldIcon : images.upArrowCircleIcon}
                                alt="upvotes"
                            />
                        </span>
                    </div>
                    <Link to={commentsLink} className={css.p2In}>
                        <span className={css.p2Box}>
                            <span className={css.p2Txt}>{upvotes}</span>
                            <img className={css.p2Icon} src={images.chatIcon} alt="upvotes" />
                        </span>
                    </Link>
                </div>
            </div>
